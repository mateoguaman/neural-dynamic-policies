...
if __name__ == "__main__":
    ...
    exp_id = args.run_id
    if args.name:
        args.save_dir = f"{log_path}/{args.name}/{exp_id}_{args.type}_{args.env_name}_s"
    else:
        args.save_dir = f"{log_path}/{exp_id}_{args.type}_{args.env_name}_s"
